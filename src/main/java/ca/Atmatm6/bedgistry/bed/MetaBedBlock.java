package ca.Atmatm6.bedgistry.bed;
...
public class MetaBedBlock extends BlockDirectional
{
    ...
    public boolean onBlockActivated(World p_149727_1_, int x, int y, int z, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        {
            int i1 = p_149727_1_.getBlockMetadata(x, y, z);
            ...
            if (!isBlockHeadOfBed(i1))
            {
                ...
                if (p_149727_1_.getBlock(x, y, z) != this)
                {
                    return true;
                }

                i1 = p_149727_1_.getBlockMetadata(x, y, z);
            }

            if (p_149727_1_.provider.canRespawnHere() && p_149727_1_.getBiomeGenForCoords(x, z) != BiomeGenBase.hell)
            {
                if (func_149976_c(i1))
                {
                    ...
                    func_149979_a(p_149727_1_, x, y, z, false);
                }

                EntityPlayer.EnumStatus enumstatus = p_149727_5_.sleepInBedAt(x, y, z);

                if (enumstatus == EntityPlayer.EnumStatus.OK)
                {
                    func_149979_a(p_149727_1_, x, y, z, true);
                    return true;
                }
                else
                {
            ...
            else
            {
                ...
                p_149727_1_.setBlockToAir(x, y, z);
                ...
                p_149727_1_.newExplosion((Entity)null, (double)((float)x + 0.5F), (double)((float)y + 0.5F), (double)((float)z + 0.5F), 5.0F, true, true);
                return true;
            }
        }
    }
